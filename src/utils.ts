...
/** Redimensionne et compresse une image côté client via canvas.
 *  Renvoie un data URL JPEG prêt à stocker. */
export function compressImage(file: File, max = 800, quality = 0.72): Promise<string> {
